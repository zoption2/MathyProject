...
namespace Fallencake.Tools
{
	...
	public class FCInfoAttributeDrawer : PropertyDrawer
	{
		...
		FCInfoAttribute informationAttribute { get { return ((FCInfoAttribute)attribute); } }
		...
		protected virtual bool HelpEnabled()
		{
			...
			{
				if (EditorPrefs.GetBool("FCShowHelpInInspectors"))
				{
					helpEnabled = true;
				}
			}
